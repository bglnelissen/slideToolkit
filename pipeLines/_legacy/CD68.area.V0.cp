...
LoadImages:[module_num:1|svn_version:\'11587\'|variable_revision_number:11|show_window:False|notes:\x5B\'1. Find Tissue area (green)\', \'2. Within Tissue area (green) Identify\x3A\', \' a. HE nuclei (blue)\', \' b. DAB area (yellow)\', \'3. Within DAB area (yellow) Identify\x3A\', \' a. DAB nuclei (red)\'\x5D]
...
IdentifyPrimaryObjects:[module_num:5|svn_version:\'10826\'|variable_revision_number:8|show_window:False|notes:\x5B"Identify Tissue area\'s (green)"\x5D]
...
UnmixColors:[module_num:6|svn_version:\'10829\'|variable_revision_number:2|show_window:False|notes:\x5B\'Split HE and DAB into separate channels\'\x5D]
    Stain count:2
...
MaskImage:[module_num:7|svn_version:\'10428\'|variable_revision_number:3|show_window:False|notes:\x5B\'Only analyse DAB in the previously defined Tissue\'\x5D]
...
MaskImage:[module_num:8|svn_version:\'10428\'|variable_revision_number:3|show_window:False|notes:\x5B\'Only analyse HE in the previously defined Tissue (green)\'\x5D]
...
IdentifyPrimaryObjects:[module_num:9|svn_version:\'10826\'|variable_revision_number:8|show_window:False|notes:\x5B"Identify DAB positive area\'s (yellow)"\x5D]
...
OverlayOutlines:[module_num:10|svn_version:\'10672\'|variable_revision_number:2|show_window:False|notes:\x5B\'The next outline is ontop of the previous one.\'\x5D]
...
SaveImages:[module_num:11|svn_version:\'10822\'|variable_revision_number:7|show_window:False|notes:\x5B\'Save outlined images\', \'These image are usually not used for further analysis and can be stored in lossy JPEG if wanted.\'\x5D]
...
MeasureImageAreaOccupied:[module_num:12|svn_version:\'10563\'|variable_revision_number:3|show_window:False|notes:\x5B\'Measure Tissue (green) and HE nuclei (blue) and DAB area (yellow) and red) area\'\x5D]
    Hidden:2
...
ExportToDatabase:[module_num:13|svn_version:\'10962\'|variable_revision_number:20|show_window:False|notes:\x5B\'Export findings to database for further analysis\'\x5D]
