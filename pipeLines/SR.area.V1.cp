...
LoadImages:[module_num:1|svn_version:\'Unknown\'|variable_revision_number:11|show_window:False|notes:\x5B\'# Load brightfield and polorizes SR slides\', \'Goal\x3A Measure collagen and total tissue area (SR_POLARIZED and SR)\', \'We define SR_POLARIZED as blue and SR as green\'\x5D]
...
Smooth:[module_num:5|svn_version:\'Unknown\'|variable_revision_number:1|show_window:False|notes:\x5B\'# SR\', \'We need to smooth the previous identified black marker dots a bit to fill small holes\'\x5D]
...
IdentifyPrimaryObjects:[module_num:9|svn_version:\'Unknown\'|variable_revision_number:8|show_window:False|notes:\x5B\'# SR\', \'Find tissue using the grayscale image.\', \'Diameter is choosen after some testing.\', \'These settings were chosen after multiple tests\'\x5D]
