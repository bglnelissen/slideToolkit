...
UnmixColors:[module_num:2|svn_version:\'Unknown\'|variable_revision_number:2|show_window:False|notes:\x5B\'Split HE and Liquid Permanent Red into separate channels\'\x5D]
    Stain count:3
    Color image:Original
    Image name:Liquid Permanent Red
    Stain:Custom
    Red absorbance:0.0684437
    Green absorbance:0.615381
    Blue absorbance:0.785253
...
IdentifyPrimaryObjects:[module_num:3|svn_version:\'Unknown\'|variable_revision_number:8|show_window:False|notes:\x5B"Identify LPR positive area\'s (yellow)"\x5D]
    Select the input image:Liquid Permanent Red
    Name the primary objects to be identified:LPRed_object
    ...
    Lower and upper bounds on threshold:0.20,1.0
    ...
    Name the outline image:LPR_object_yellow
...
MaskImage:[module_num:4|svn_version:\'Unknown\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Select the input image:Hematoxylin
    Name the output image:LPR_Masked
    Use objects or an image as a mask?:Objects
    Select object for mask:LPRed_object
    Select image for mask:None
    Invert the mask?:No

IdentifyPrimaryObjects:[module_num:5|svn_version:\'Unknown\'|variable_revision_number:8|show_window:False|notes:\x5B\x5D]
    Select the input image:LPR_Masked
    ...
    Suppress local maxima that are closer than this minimum allowed distance:7
    Speed up by using lower-resolution image to find local maxima?:Yes
    Name the outline image:Nuclei_object_green
    Fill holes in identified objects?:Yes
    Automatically calculate size of smoothing filter?:Yes
    Automatically calculate minimum allowed distance between local maxima?:Yes
    Manual threshold:0.0
...
OverlayOutlines:[module_num:6|svn_version:\'Unknown\'|variable_revision_number:2|show_window:False|notes:\x5B\'The next outline is ontop of the previous one.\'\x5D]
    ...
    Width of outlines:1
    Select outlines to display:LPR_object_yellow
    Select outline color:Yellow
    Select outlines to display:Nuclei_object_green
    Select outline color:Green

SaveImages:[module_num:7|svn_version:\'Unknown\'|variable_revision_number:7|show_window:False|notes:\x5B\'Save outlined images\', \'These image are usually not used for further analysis and can be stored in lossy JPEG if wanted.\'\x5D]
...
MeasureImageAreaOccupied:[module_num:8|svn_version:\'Unknown\'|variable_revision_number:3|show_window:False|notes:\x5B\'Measure Tissue (green) and HE nuclei (blue) and DAB area (yellow) and red) area\'\x5D]
    Hidden:1
    ...
    Select a binary image to measure:LPR_object_yellow

ExportToDatabase:[module_num:9|svn_version:\'Unknown\'|variable_revision_number:20|show_window:False|notes:\x5B\'Export findings to database for further analysis\'\x5D]
