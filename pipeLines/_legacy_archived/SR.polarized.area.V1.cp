...
LoadImages:[module_num:1|svn_version:\'Unknown\'|variable_revision_number:11|show_window:False|notes:\x5B\'# Load polarized SR slides\', \'Goal\x3A Measure polarized collagen area (SR_POLARIZED)\', \'We define SR_POLARIZED as blue\'\x5D]
...
IdentifyPrimaryObjects:[module_num:4|svn_version:\'Unknown\'|variable_revision_number:8|show_window:False|notes:\x5B\'# SR_POLARIZED\', \'Find tissue using the grayscale image.\', \'Diameter is choosen after some testing.\', \'These settings are choosen after multiple tests\'\x5D]
    Select the input image:SR_POLARIZED.Gray
    Name the primary objects to be identified:SR_POLARIZED.TISSUE.blue
    Typical diameter of objects, in pixel units (Min,Max):3,99999999
