...
LoadImages:[module_num:1|svn_version:\'Unknown\'|variable_revision_number:11|show_window:True|notes:\x5B\'1. Find Tissue area (green)\', \'2. Within Tissue area (green) Identify\x3A\', \' a. HE nuclei (blue)\', \' b. DAB area (yellow)\', \'3. Within DAB area (yellow) Identify\x3A\', \' a. DAB nuclei (red)\'\x5D]
...
ColorToGray:[module_num:2|svn_version:\'Unknown\'|variable_revision_number:2|show_window:True|notes:\x5B\'Create gray channel, this is used to find tissue (green)\', \'Red is ussually a good channel for tissue.\', \'RGB should also be fine.\'\x5D]
...
Morph:[module_num:3|svn_version:\'Unknown\'|variable_revision_number:2|show_window:True|notes:\x5B\'Invert created gray channel\'\x5D]
...
Smooth:[module_num:4|svn_version:\'Unknown\'|variable_revision_number:1|show_window:True|notes:\x5B\'Smooth away the dust using a Gaussion Filter. This is used to find Tissue (green)\'\x5D]
...
IdentifyPrimaryObjects:[module_num:5|svn_version:\'Unknown\'|variable_revision_number:8|show_window:True|notes:\x5B"Identify Tissue area\'s (green)"\x5D]
    ...
    Lower and upper bounds on threshold:0.08,1.0
...
UnmixColors:[module_num:6|svn_version:\'Unknown\'|variable_revision_number:2|show_window:True|notes:\x5B\'Split HE and DAB into separate channels\'\x5D]
    Stain count:2
...
MaskImage:[module_num:7|svn_version:\'Unknown\'|variable_revision_number:3|show_window:True|notes:\x5B\'Only analyse DAB in the previously defined Tissue\'\x5D]
...
MaskImage:[module_num:8|svn_version:\'Unknown\'|variable_revision_number:3|show_window:True|notes:\x5B\'Only analyse HE in the previously defined Tissue (green)\'\x5D]
...
IdentifyPrimaryObjects:[module_num:9|svn_version:\'Unknown\'|variable_revision_number:8|show_window:True|notes:\x5B"Identify DAB positive area\'s (yellow)"\x5D]
...
MaskImage:[module_num:10|svn_version:\'Unknown\'|variable_revision_number:3|show_window:True|notes:\x5B\'Only analyse Nuclei (red) in the previously defined DAB tissue (yellow)\'\x5D]
    Select the input image:DAB
...
IdentifyPrimaryObjects:[module_num:11|svn_version:\'Unknown\'|variable_revision_number:8|show_window:True|notes:\x5B\'Find DAB positive nuclei (red) within masked image (green)\'\x5D]
...
IdentifyPrimaryObjects:[module_num:12|svn_version:\'Unknown\'|variable_revision_number:8|show_window:True|notes:\x5B\'Find HE positive nuclei (blue) within masked image (green)\'\x5D]
    Select the input image:Tissue_Masked_HE-channel
...
OverlayOutlines:[module_num:13|svn_version:\'Unknown\'|variable_revision_number:2|show_window:True|notes:\x5B\'The next outline is ontop of the previous one.\'\x5D]
...
SaveImages:[module_num:14|svn_version:\'Unknown\'|variable_revision_number:7|show_window:True|notes:\x5B\'Save outlined images\', \'These image are usually not used for further analysis and can be stored in lossy JPEG if wanted.\'\x5D]
...
MeasureImageAreaOccupied:[module_num:15|svn_version:\'Unknown\'|variable_revision_number:3|show_window:True|notes:\x5B\'Measure Tissue (green) and HE nuclei (blue) and DAB area (yellow) and red) area\'\x5D]
    Hidden:4
...
ExportToDatabase:[module_num:16|svn_version:\'Unknown\'|variable_revision_number:20|show_window:True|notes:\x5B\'Export findings to database for further analysis\'\x5D]
