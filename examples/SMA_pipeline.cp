...
LoadImages:[module_num:1|svn_version:\'Unknown\'|variable_revision_number:11|show_window:False|notes:\x5B\'# Goal\x3A Measure total tissue area, DAB area\', \'# Outlines\x3A  Nuclei blue, DAB area yellow\'\x5D]
    File type to be loaded:individual images
    File selection method:Text-Exact match
    Number of images in each group?:3
    Type the text that the excluded images have in common:.empty
    ...
    Regular expression that finds metadata in the file name:^(?P<NR>\x5B^.\x5D*)\\.(?P<STAIN>\x5B^.\x5D*).(?P<EXTRA>\x5B^.\x5D*)\\.X(?P<X>\x5B0-9\x5D{1,4}).*\\.Y(?P<Y>\x5B0-9\x5D{1,4})
...
IdentifyPrimaryObjects:[module_num:3|svn_version:\'Unknown\'|variable_revision_number:8|show_window:False|notes:\x5B\'Define HE positive area\'\x5D]
    Select the input image:Hematoxylin
    Name the primary objects to be identified:HematoxylinArea
    Typical diameter of objects, in pixel units (Min,Max):10,40000
    ...
    Name the outline image:HematoxylinAreaOutlines
...
IdentifyPrimaryObjects:[module_num:4|svn_version:\'Unknown\'|variable_revision_number:8|show_window:False|notes:\x5B\'Define DAB positive area\'\x5D]
    Select the input image:DAB
    Name the primary objects to be identified:DABArea
    Typical diameter of objects, in pixel units (Min,Max):10,40000
    Discard objects outside the diameter range?:No
    Try to merge too small objects with nearby larger objects?:Yes
    Discard objects touching the border of the image?:No
    ...
    Suppress local maxima that are closer than this minimum allowed distance:7
    Speed up by using lower-resolution image to find local maxima?:Yes
    Name the outline image:DABAreaOutlines
    Fill holes in identified objects?:Yes
    Automatically calculate size of smoothing filter?:Yes
    Automatically calculate minimum allowed distance between local maxima?:Yes
    Manual threshold:0.0
...
MeasureImageAreaOccupied:[module_num:5|svn_version:\'Unknown\'|variable_revision_number:3|show_window:False|notes:\x5B\'Measure DAB and HE area\'\x5D]
    ...
    Select a binary image to measure:HematoxylinAreaOutlines
    Measure the area occupied in a binary image, or in objects?:Binary Image
    Select objects to measure:None
    Retain a binary image of the object regions?:No
    Name the output binary image:Stain
    Select a binary image to measure:DABAreaOutlines

OverlayOutlines:[module_num:6|svn_version:\'Unknown\'|variable_revision_number:2|show_window:False|notes:\x5B\'Overlay outlines of identified objects\'\x5D]
    ...
    Width of outlines:1
    Select outlines to display:HematoxylinAreaOutlines
    Select outline color:Blue
    Select outlines to display:DABAreaOutlines
    Select outline color:Yellow

SaveImages:[module_num:7|svn_version:\'Unknown\'|variable_revision_number:7|show_window:False|notes:\x5B\'Save outlined images for validating objects\'\x5D]
...
ExportToDatabase:[module_num:8|svn_version:\'Unknown\'|variable_revision_number:20|show_window:False|notes:\x5B\'Export findings to database for further analysis\'\x5D]
