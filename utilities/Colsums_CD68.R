...
VAL = sum(df$AreaOccupied_AreaOccupied_DAB_object)
VAL2 = sum(df$AreaOccupied_AreaOccupied_nuclei_DAB)
VAL3 = sum(df$AreaOccupied_AreaOccupied_HE_object)
VAL4 = sum(df$AreaOccupied_AreaOccupied_nuclei_HE)
VAL5 = sum(df$AreaOccupied_AreaOccupied_Tissue_object)
# original code
# VAL = sum(df$AreaOccupied_AreaOccupied_DAB_object_yellow) / sum(df$AreaOccupied_AreaOccupied_Tissue_object_green)
cat( VAL, VAL2, VAL3, VAL4, VAL5, sep = ", " )
